      ...
      <header className="grid  gap-5">
        <div className="flex flex-col gap-5">
          ...
          <p className="text-xl m-0">
            Native Twin allows developers to apply Tailwind CSS styling across
            both React Native (for mobile) and React (for web) applications.
            With an intuitive syntax, you can leverage your existing knowledge
            of Tailwind CSS for seamless application styling. Built with
            performance in mind, Native Twin ensures efficient rendering and a
      ...
      <section className="py-[50px] flex flex-col items-center gap-5">
        <div className="gap-4 flex flex-col items-center justify-center my-[20px]">
          ...
          <p className="text-center max-w-[900px]">
            Discover how Native Twin transforms development by allowing you to
            use Tailwind CSS classes in both environments. The simplicity and
            efficiency it offers will change the way you build your
            applications.
          </p>
          <a href="/documentation">
      ...
      <section className="py-[50px] flex flex-col  gap-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {features.map((feature, index) => (
            <View
              key={index}
              className="p-5 bg-gray-800 text-white shadow-md rounded-lg"
            >
